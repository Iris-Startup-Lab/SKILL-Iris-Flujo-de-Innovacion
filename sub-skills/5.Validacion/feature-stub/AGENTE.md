...
El flujo diseñaba los experimentos pero no sabía leerlos: «clic en la funcionalidad: 37 de 420» se comparaba
...
python sub-skills/5.Validacion/feature-stub/scripts/analizar_resultados.py \
    --k 37 --n 420 --umbral 0.06 --metrica "clic en la funcionalidad" \
...
python sub-skills/5.Validacion/feature-stub/scripts/analizar_resultados.py \
    --k 37 --n 420 --control-k 12 --control-n 400 --metrica "clic en la funcionalidad"
```
...
concluir— **cuántos visitas más harían falta**. Con `--datos` acepta varias variantes a la vez.
