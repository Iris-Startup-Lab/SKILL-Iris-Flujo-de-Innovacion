...
El entregable principal de esta skill es el **HTML detallado que ella misma produce**, no el
de la plantilla compartida. Lo define su `SKILL.md`: ver «Como paso del flujo IRIS».
